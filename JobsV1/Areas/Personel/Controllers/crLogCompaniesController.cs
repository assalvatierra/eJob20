...
namespace JobsV1.Areas.Personel.Controllers
{
    public class crLogCompaniesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Status,IsShuttle, IsInternal")] crLogCompany crLogCompany)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Status,IsShuttle, IsInternal")] crLogCompany crLogCompany)
        {
            if (ModelState.IsValid && InputValidation(crLogCompany))
            {
