...
namespace JobsV1.Areas.Personel.Controllers
{
    public class crLogUnitsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description,OrderNo,Status,crLogOwnerId,Remarks")] crLogUnit crLogUnit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description,OrderNo,Status,crLogOwnerId,Remarks")] crLogUnit crLogUnit)
        {
            if (ModelState.IsValid && InputValidation(crLogUnit))
            {
